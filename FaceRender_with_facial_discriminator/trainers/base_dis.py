...
class BaseTrainer(object):
    ...
    def __init__(self,
        ...
        self.opt = opt
        self.net_G = net_G
        self.net_d_left_eye = net_d_left_eye
        self.net_d_right_eye = net_d_right_eye
        self.net_d_mouth = net_d_mouth
        self.opt_d_left_eye = opt_d_left_eye
        self.opt_d_right_eye = opt_d_right_eye
        self.opt_d_mouth = opt_d_mouth
        self.net_G = net_G
        if opt.distributed:
            self.net_G_module = self.net_G.module
            self.net_d_left_eye_module = net_d_left_eye.module
            self.net_d_right_eye_module = net_d_right_eye.module
            self.net_d_mouth_module = net_d_mouth.module
        else:
            self.net_G_module = self.net_G
            self.net_d_left_eye_module = net_d_left_eye
            self.net_d_right_eye_module = net_d_right_eye
            self.net_d_mouth_module = net_d_mouth
    ...
    def save_checkpoint(self, current_epoch, current_iteration):
        ...
        _save_checkpoint(self.opt,
                         ...
                         self.net_d_left_eye, self.net_d_right_eye, 
                         self.net_d_mouth, self.opt_d_left_eye,
                         self.opt_d_right_eye, self.opt_d_mouth,
    ...
    def _load_checkpoint(self, checkpoint_path, resume=True):
        ...
        if self.opt.phase == 'train' and resume:
            ...
            try:
                ...
                print('no optimizers and schdules')
    ...
    torch.save(
        {
            ...
            'opt_d_left_eye': opt_d_left_eye.state_dict(),
            'opt_d_right_eye': opt_d_right_eye.state_dict(),
            'opt_d_mouth': opt_d_mouth.state_dict(),
